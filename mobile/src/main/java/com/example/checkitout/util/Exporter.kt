 ...
 *
 * Stored Spotify / Apple Music URLs are used when present. Otherwise Apple
 * Music is resolved on demand and Spotify falls back to a search link.
 *
            ...
            tracks.map { t ->
                async {
                    ...
                    Row(
                        ...
                        spotify = t.spotifyUrl ?: MusicLinks.spotifySearchUrl(t),
                        appleMusic = apple,
