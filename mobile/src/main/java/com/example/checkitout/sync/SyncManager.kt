...
object SyncManager {
    ...
    private fun trackToJson(t: LikedTrack): JSONObject = JSONObject().apply {
        ...
        putOpt("triggerSource", t.triggerSource)
        putOpt("mediaId", t.mediaId)
        putOpt("mediaUri", t.mediaUri)
        putOpt("spotifyUrl", t.spotifyUrl)
        putOpt("appleMusicUrl", t.appleMusicUrl)
    }
    ...
    private fun jsonToTrack(o: JSONObject): LikedTrack {
        ...
        return LikedTrack(
            ...
            triggerSource = o.optStringOrNull("triggerSource"),
            mediaId = o.optStringOrNull("mediaId"),
            mediaUri = o.optStringOrNull("mediaUri"),
            spotifyUrl = o.optStringOrNull("spotifyUrl"),
            appleMusicUrl = o.optStringOrNull("appleMusicUrl"),
        )
    }
